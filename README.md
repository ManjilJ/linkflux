...
*   🔢 **Equation-Driven**: Generates complex branching patterns using custom mathematical axioms.
*   🗿 **Figurine Synthesis**: Renders abstract connectome data into solid, 3D-like figurines.
*   🌫️ **Transient Motion**: Visualizations emerge and fade quickly, creating a "pulsing" stream of consciousness effect.
*   📍 **Data-Point Mapping**: Processes coordinate sets into interactive nodes and links.
*   ⚡ **Lightweight**: Built with vanilla JavaScript and HTML5 Canvas for maximum performance.
